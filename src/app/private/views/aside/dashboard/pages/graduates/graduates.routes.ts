...
export const privateRoutes: Routes = [
  {
    ...
    loadComponent: () =>
      import('./views/graduates-add/graduates-add.component'),
  },
  {
    path: 'manage-graduates',
    title: 'Adminsitrar Graduados',
    loadComponent: () =>
      import('./views/graduates-list/graduates-list.component'),
  },
  {
    ...
    loadComponent: () =>
      import(
        './views/graduates-details/graduates-details.component'
      ),
  },
